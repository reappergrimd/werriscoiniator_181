...
import com.nitinsurana.bitcoinlitecoin.rpcconnector.exception.RpcInvalidResponseException;
...
import de.fireearth.werri.werriscoiniator.Wallet;
public class RPCApp {
    ...
    public RPCApp(String rpcUser, String rpcPassword, String rpcHost, String rpcPort) throws AuthenticationException {
    ...
    public static RPCApp getAppOutRPCconf(String conf) throws Exception {
        ...
        String rpcUser = "guaranyrpc";
        String rpcPassword = "48qfPXqrSFUknRVrvPEJAR4z9nop71JSTxmiHZQnrEVd";
        ...
        RPCApp app = new RPCApp(rpcUser, rpcPassword, rpcHost, rpcPort);
        return app;
    }
     ...
     * @throws com.nitinsurana.bitcoinlitecoin.rpcconnector.exception.CryptoCurrencyRpcException
     */
    public double getBalance(String account) throws CryptoCurrencyRpcException {
     ...
     * @throws com.nitinsurana.bitcoinlitecoin.rpcconnector.exception.CryptoCurrencyRpcException
     */
    public double getBalance() throws CryptoCurrencyRpcException {
    ...
    public JsonObject listAccounts() throws CryptoCurrencyRpcException {
        ...
        cryptoCurrencyRpcExceptionHandler.checkException(jsonObj);
        Bukkit.getLogger().info("Your Account Ceck: " +jsonObj.get("result").getAsJsonObject());
        return jsonObj.get("result").getAsJsonObject();
    }
     ...
     * @throws com.nitinsurana.bitcoinlitecoin.rpcconnector.exception.CryptoCurrencyRpcException
     */
    public String sendFrom(String fromAccount, String toAddress, Double amount) throws CryptoCurrencyRpcException {
     ...
     * @throws com.nitinsurana.bitcoinlitecoin.rpcconnector.exception.CryptoCurrencyRpcException
     */
    public String sendToAddress(Wallet paymentWallet, double landPrice) throws CryptoCurrencyRpcException {
        JsonObject jsonObj = callAPIMethod(APICalls.SEND_TO_ADDRESS, paymentWallet.address, landPrice);
        cryptoCurrencyRpcExceptionHandler.checkException(jsonObj);
        return jsonObj.get("result").getAsString();
    }
